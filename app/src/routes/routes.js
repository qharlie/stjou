...
const ImportsPage = () =>
    import(/* webpackChunkName: "imports" */ '@/pages/ImportsPage.vue');
const GroupedTradesPage = () =>
    import(/* webpackChunkName: "imports" */ '@/pages/GroupedTrades.vue');
// Components pages
const Buttons = () =>
...
// TableList pages
const FullTradesTable = () =>
  import(/* webpackChunkName: "tables" */ '@/pages/Tables/TradesTable.vue');
  ...
  children: [
    {
      path: 'regular',
      name: 'Trades Table',
      components: { default: FullTradesTable }
    },
    {
      path: 'extended',
